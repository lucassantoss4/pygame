...
bomba_img = pygame.image.load('bb.png').convert_alpha() # carrega imagem da bomba
...
# ===== Loop principal =====
# ===== Loop principal =====
# Adicionando a variável que controla o pulo
pulando = False
pulo_inicial = jogador.rect.bottom  # Posição inicial do salto
...
while game:
    ...
    for evento in pygame.event.get():
        ...
        if evento.type == pygame.KEYDOWN:
            ...
            if evento.key == pygame.K_RIGHT or evento.key == pygame.K_d:
                jogador.speedx += 5
            if evento.key == pygame.K_w and not pulando:  # Verifica se não está pulando para evitar pulos consecutivos
                pulando = True
                jogador.speedy = -15  # Define a velocidade inicial do pulo
    ...
    # Atualizando a posição vertical do pulo
    if pulando:
        jogador.rect.y += jogador.speedy
        jogador.speedy += 1  # Adiciona gravidade ao pulo
        
        # Verifica se atingiu o ponto mais alto do pulo
